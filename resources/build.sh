...
echo "Bundling sub0graphiql.js..."
browserify -g browserify-shim -s Sub0GraphiQL dist/myindex.js > sub0graphiql.js
echo "Bundling sub0graphiql.min.js..."
browserify -g browserify-shim -g uglifyify -s Sub0GraphiQL dist/myindex.js 2> /dev/null | uglifyjs -c --screw-ie8 > sub0graphiql.min.js 2> /dev/null
